...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden" id="about">
      ...
      <div className="relative z-20 max-w-3xl mx-auto px-6 py-20 text-center">

        {/* AVATAR — small, centered, above name */}
        <FadeIn delay={0.1}>
          <div className="mx-auto w-20 h-20 md:w-24 md:h-24 mb-6">
            <div className="relative w-full h-full rounded-full overflow-hidden border border-slate-600/40 bg-slate-900 shadow-lg shadow-sky-400/10">
              <img
        ...
        <FadeIn delay={0.15}>
          <p className="text-xs font-medium uppercase tracking-[2px] text-sky-400 mb-4">
            Engineering Lead · Mobile & Web Platforms
          </p>
        </FadeIn>
        ...
        <FadeIn delay={0.25}>
          <p className="mt-5 text-base text-slate-400 max-w-2xl mx-auto leading-relaxed">
            ...
            <span className="text-slate-200 font-semibold">12 developers</span>{' '}
            through a monolith-to-microservices migration serving{' '}
            <span className="text-sky-400 font-semibold">100K+ SMEs</span>{' '}
            (18 months, zero incidents).{' '}
            <span className="text-slate-200 font-semibold">10+ years</span>{' '}
            spanning HealthTech (16 Australian hospitals), FinTech ($46M-funded marketplace), and InsurTech (award-winning platform). 12 months fully remote contract with Australian stakeholders.
          </p>
        </FadeIn>
